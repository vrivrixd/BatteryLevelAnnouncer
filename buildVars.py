...
addon_info = {
	...
	"addon_name": "BatteryLevelAnnouncer",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Battery Level Announcer"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""Announces the battery level automatically, either with sound or speech."""),
	# version
	"addon_version": "1.0",
	# Author(s)
	"addon_author": "Vitor Bruski <vrivrivb123@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/vrivrixd/BatteryLevelAnnouncer",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/vrivrixd/BatteryLevelAnnouncer",
